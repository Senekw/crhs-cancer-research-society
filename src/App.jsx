...
const officerLink =
  "https://docs.google.com/forms/d/e/1FAIpQLSc4ANO5YMXIKc0_X6SXSEFmEUVvuR1_NSKS59hCiRwwIGPl1Q/viewform";

const memberLink =
  "https://docs.google.com/forms/d/e/1FAIpQLSe6P1e5gv2LLlf7xdrfqEBizH1zErdTkHMAI4tHaKlfm7N0tg/viewform";
    ...
    <main>
      ...
      <section className="hero">
        <div className="heroText">
          <span className="pill">
            Student-Led Oncology Research & Education
          </span>

          <h2>
            Advancing curiosity in cancer research, medicine, and innovation.
          </h2>

          <p>
            Cancer Research Society is a student organization focused on oncology
            education, scientific communication, research mentorship, and
            emerging discoveries in cancer care.
          </p>
        ...
        <Card className="heroCard">
          ...
          <h3>Student-founded. Research-mentored.</h3>
      ...
      <section id="about" className="section twoCol">
        <div>
          ...
          <h2>
            Building future leaders in oncology and translational science.
          </h2>

          <p>
            Members learn how to read scientific literature, evaluate clinical
            trials, explain complex cancer topics clearly, and create
            professional presentations for students and the community.
          </p>
        ...
        <div className="features">
          <Card>
            ...
            <p>
              Journal clubs, trial review, study design, and abstract/poster
              development.
            </p>
          </Card>
          ...
          <Card>
            <Brain />
            <h3>AI & Precision Medicine</h3>
            <p>
              Educational reviews on AI, genomics, biomarkers, and personalized
              oncology.
            </p>
          </Card>
          ...
          <Card>
            <Users />
            <h3>Mentorship & Outreach</h3>
            <p>
              Research opportunities, cold-email training, leadership, and
              community education.
            </p>
          </Card>
        </div>
      ...
      <section id="presentations" className="section darkSection">
        <div className="sectionHeader">
          ...
          <p>
            Check back daily for new oncology research updates, presentation
            highlights, and Cancer Research Society learning resources.
          </p>
        </div>
      ...
      <section id="apply" className="section">
        ...
        <div className="applyGrid">
          <Card className="qrCard">
            <img
              src="/officer-application-qr.png"
              alt="Officer Application QR Code"
            />

            <h3>Officer Application</h3>

            <p>
              Apply for leadership roles in research, outreach, social media,
              events, or education.
            </p>
          ...
          <Card className="qrCard">
            <img
              src="/membership-application-qr.png"
              alt="Membership Application QR Code"
            />

            <h3>Membership Application</h3>

            <p>
              Join CRS to participate in presentations, research workshops, and
      ...
      <section id="contact" className="section contact">
        <Card>
          ...
          <p>
            ASCO Post review series, research poster workshops, guest speaker
            sessions, and cancer awareness outreach.
          </p>
        </Card>
        ...
        <Card>
          ...
          <p>
            <a href="mailto:crhscrs@gmail.com">crhscrs@gmail.com</a>
          </p>

          <p>
            <ExternalLink size={16} /> @crhscancerresearchsociety
          </p>
        </Card>
      </section>
